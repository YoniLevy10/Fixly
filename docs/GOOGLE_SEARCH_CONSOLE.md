...
| דומיין / נתיב | מה מוצג |
|---------------|---------|
| `https://fixly.tech/waitlist` | **קנוני לקמפיין ביקוש** — דף נחיתה מעוצב |
| `https://fixly.tech/pro/join` | הצטרפות בעלי מקצוע (מנוע לידים) |
| `https://fixly.tech/` | דמו מוצר כל עוד הדמו פעיל; דף נחיתה רק אחרי כיבוי דמו + prelaunch |
