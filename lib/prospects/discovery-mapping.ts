...
export const DISCOVERY_CATEGORY_MAP: DiscoveryCategoryMapping[] = [
  ...
  },
  {
    ...
    placesQueryEn: 'house cleaning Jerusalem',
    placesQueriesEnExtra: ['apartment cleaner', 'home cleaning service'],
  ...
  },
  {
    ...
    placesQueriesHeExtra: ['צבעי', 'צביעת דירה', 'צבעי מבנים', 'צבעי קירות'],
